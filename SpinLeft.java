...
@Autonomous(name="Spin Left (Blue)", group="Iterative Opmode")
// bhat
public class CarospuelLeft extends OpMode
{
    ...
    public void forward(){
        ...
        leftDrive.setTargetPosition(-3800);
        back_left_drive.setTargetPosition(-3800);
        rightDrive.setTargetPosition(-2800);
        back_right_drive.setTargetPosition(-2800);
        spin.setTargetPosition(-1000000);
